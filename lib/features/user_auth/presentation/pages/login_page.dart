...
class _LoginPageState extends State<LoginPage> {
                ...
                child: Column(
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        color: Color.fromARGB(255, 123, 181, 35),
                        fontWeight: FontWeight.bold,
                        fontSize: 35, // Taille de police de 24 points
                      ),
                    ),
  ...
  void _signIn() async {
    ...
    if (user != null) {
      ...
      showToast(message: "Une erreur s'est produite lors de la connexion de l'utilisateur.");
    }
  }
